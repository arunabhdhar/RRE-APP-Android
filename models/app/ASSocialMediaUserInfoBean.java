...
public class ASSocialMediaUserInfoBean implements Parcelable{
	...
	public ASSocialMediaUserInfoBean(Parcel source) {
	...
	public ASSocialMediaUserInfoBean() {

	}
	public ASSocialMediaUserInfoBean(JSONObject obj) throws JSONException {
		if(obj.has("UserId")){
	...
	public static final Creator<ASSocialMediaUserInfoBean> CREATOR= new Creator<ASSocialMediaUserInfoBean>(){
		@Override
		public ASSocialMediaUserInfoBean createFromParcel(Parcel source) {
			return new ASSocialMediaUserInfoBean(source);
		}
		@Override
		public ASSocialMediaUserInfoBean[] newArray(int size) {

			return new ASSocialMediaUserInfoBean[size];
		}
